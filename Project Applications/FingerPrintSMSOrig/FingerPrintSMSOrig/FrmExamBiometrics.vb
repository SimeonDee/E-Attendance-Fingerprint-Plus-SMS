...
Public Class FrmExamBiometrics
        ...
        Try
            ...
            If lstAttendance.Items.Count > 0 Then
                For i As Integer = 0 To (lstAttendance.Items.Count - 1)
                    ...
                    sql = "INSERT INTO ExamAttendance(TheDate,InvigilatorID,Matric,CCode,Dept,TheSession,Semester," & _
                            "TheLevel,TheProgram,Venue,TheTime) " & _
                            "VALUES(#" & CDate(FrmInvigilatorForm.TheDate) & "#,'" & _
                            FrmInvigilatorForm.InvigilatorID & "','" & _
                            lstAttendance.Items.Item(i).ToString.Trim & "','" & _
                            FrmInvigilatorForm.Code & "','" & _
                            FrmInvigilatorForm.Dept & "','" & _
                            FrmInvigilatorForm.TheSession & "','" & _
                            FrmInvigilatorForm.Semester & "','" & _
                            FrmInvigilatorForm.Level & "','" & _
                            FrmInvigilatorForm.TheProgram & "','" & _
                            FrmInvigilatorForm.Venue & "','" & _
                            FrmInvigilatorForm.TheTime & "')"
    ...
    Private Sub FrmExamBiometrics_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        myUtil.FinalizeGrFinger()
        If cn.State = ConnectionState.Open Then MyModule.DisconnectFromDbase(cn)
    End Sub

    Private Sub FrmExamBiometrics_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim err As Integer
        ...
        '---Adds title of page---
        lblTitle.Text &= "  " & FrmInvigilatorForm.Code

        'load registered students into Listbox
        For i As Integer = 0 To (FrmInvigilatorForm.registeredStudents.Count - 1)
            lstRegStudents.Items.Add(FrmInvigilatorForm.registeredStudents.Item(i).ToString)
        Next
        ...
        Try
            ...
            If rdr1.HasRows Then
                ...
                Dim sql2 As String = "SELECT * FROM RegisteredCourses WHERE " & _
                                    "Matric='" & matric & "' AND CCode='" & FrmInvigilatorForm.Code & "'"
